...
import { ZongjuQuestBanner } from "@/components/admin/ZongjuQuestBanner";
import { getZongjuQuests } from "@/lib/quests";
...
export default async function AdminHomePage() {
  ...
  const doneQuests = await getZongjuQuests();
  ...
  return (
    <div>
      ...
      <ZongjuQuestBanner quests={doneQuests} />
