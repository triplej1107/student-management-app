...
// 업무 체크리스트는 탭에서 빼고 조교홈 안으로 넣었다 — 매일 여는 홈에서
// 바로 체크하는 게 자연스럽고, 그 자리는 주말마다 쓰는 강의 출결이 더 급하다.
export const STAFF_TABS: NavTab[] = [
  { href: "/staff/lecture-attendance", label: "강의 출결" },
  { href: "/staff/attendance", label: "클리닉 출결" },
